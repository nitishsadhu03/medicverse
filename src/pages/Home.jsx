...
function Home() {
  ...
  return (
    <div>
        ...
        <div class="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
          ...
          >
            <ul class="flex flex-col p-4 md:p-0 mt-4 font-medium border border-gray-100 rounded-lg bg-gray-50 md:flex-row md:space-x-8 md:mt-0 md:border-0 md:bg-white dark:bg-gray-800 md:dark:bg-gray-900 dark:border-gray-700">
              ...
              <li>
                <a
                  href="https://earnest-scone-809dcb.netlify.app/"
        ...
        <div class="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
          <div class="mr-auto place-self-center lg:col-span-7">
            <h1 class="max-w-2xl mb-4 text-4xl font-extrabold tracking-tight leading-none md:text-5xl xl:text-6xl dark:text-white">
              Empowering Health Through Knowledge And Compassion
            </h1>
      ...
      <div class="2xl:container 2xl:mx-auto lg:py-16 lg:px-20 md:py-12 md:px-6 py-9 px-4" id="#About">
            <div class="flex flex-col lg:flex-row justify-between gap-8">
                <div class="w-full lg:w-5/12 flex flex-col justify-center">
                    <h1 class="text-3xl lg:text-4xl font-bold leading-9 text-gray-800 dark:text-white pb-4">About Us</h1>
                    <p class="font-normal text-base leading-6 text-gray-600 dark:text-white">Welcome to Our Medical Blogging Community. At Medicverse, we are committed to fostering a thriving online community where medical professionals, enthusiasts, and curious minds converge to share their knowledge, insights, and experiences. Our platform serves as a hub for individuals passionate about all things medical, providing a space to learn, discuss, and connect.</p>
                </div>
            ...
            <div class="flex lg:flex-row flex-col justify-between gap-8 pt-12">
                <div class="w-full lg:w-5/12 flex flex-col justify-center">
                    ...
                    <p class="font-normal text-base leading-6 text-gray-600 dark:text-white">Our mission is to bridge the gap between medical expertise and the wider public, promoting health literacy, awareness, and collaboration. We believe that accessible and accurate medical information should be available to everyone, and our platform is designed to make this a reality.</p>
                </div>
